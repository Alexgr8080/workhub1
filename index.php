 ...
 * @version 1.2 (Includes revised by AI)
 */
...
// Include the main authentication and session setup file.
// auth.php will handle including config.php, db.php, functions.php, and session.php in the correct order.
require_once ROOT_PATH . '/includes/auth.php';

// Check if the user is already logged in
// isLoggedIn() and redirect() MUST be defined in functions.php (which is included by auth.php)
if (isLoggedIn()) {
    redirect('dashboard.php'); // Assumes redirect() handles relative paths from site root or uses SITE_URL
    exit;
}

// If not logged in, the rest of the page (HTML) will be displayed.
// SITE_NAME should be defined in config.php
$pageTitle = "Welcome to " . (defined('SITE_NAME') ? SITE_NAME : "MyWorkHub");
...
<body class="flex flex-col min-h-screen">
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <a href="index.php" class="flex-shrink-0">
                        ...
                        <span class="ml-2 text-2xl font-bold text-indigo-600"><?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : "MyWorkHub"); ?></span>
                    </a>
                </div>
    ...
    <section class="hero-section text-white py-20 md:py-32">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg md:text-xl text-indigo-100 mb-10 max-w-3xl mx-auto">
                <?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : "MyWorkHub"); ?> helps you manage your projects, tasks, and deadlines with ease. Boost your productivity and stay on top of your work like never before.
            </p>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-800">Why Choose <?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : "MyWorkHub"); ?>?</h2>
    ...
    <section class="py-16 bg-indigo-700 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-indigo-100 mb-8">
                Sign up today and experience a new level of organization and productivity with <?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : "MyWorkHub"); ?>.
            </p>
    ...
    <footer class="bg-gray-800 text-gray-300 py-12 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-sm">
                &copy; <?php echo date('Y'); ?> <?php echo htmlspecialchars(defined('SITE_NAME') ? SITE_NAME : "MyWorkHub"); ?>. Created by Dr. Ahmed AL-sadi. All Rights Reserved.
            </p>
